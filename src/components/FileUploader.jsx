...
const FileUploader = ({ setOutsFile, setPoFile, setBookFile, onProcess, isProcessing }) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-xs border border-gray-200 mb-8">
      ...
      <button onClick={onProcess} disabled={isProcessing} className="bg-blue-600 text-white px-6 py-2 rounded-sm hover:bg-blue-700 flex items-center justify-center gap-2 w-full md:w-auto disabled:opacity-70">
